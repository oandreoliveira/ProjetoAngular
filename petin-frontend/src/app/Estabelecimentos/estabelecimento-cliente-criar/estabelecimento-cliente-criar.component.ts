...
@Component({
  templateUrl: './estabelecimento-cliente-criar.component.html',
  styleUrls: ['./estabelecimento-cliente-criar.css'
  ]
})

export class EstabelecimentoClienteCriarComponent implements OnInit {
